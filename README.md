...
>this code will create folder called election and download all the needed dependencies

check if the project is working by going to this [link](http://localhost/election/web/)
